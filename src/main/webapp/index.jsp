...
<meta name="keywords"
	content="Deliccio Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
...
<link
	href='https://fonts.googleapis.com/css?family=Open+Sans:600,600italic,700,400'
	rel='stylesheet' type='text/css'>
<!-- FlexSlider -->
<link rel="stylesheet"
											...
											<div class="in-form">
												<form id="myForm" method="POST" action="LoginServlet">
													<input type="hidden" id="type" name="type" /> <input
														type="text" name="account" placeholder="帳號"
														required=required> <input type="password"
														name="password" placeholder="密碼" required=required>
													<input type="text" name="check_code" placeholder="驗證碼"
														required=required> <img src="CheckCodeServlet" />
													<br />
														...
														<div class="checkbox-form">
															...
															<div class="check-right">
																<button type="button" class="btn btn-info btn-lg"
																	data-toggle="modal" data-target="#myModal">忘記密碼</button>
																<button type="button" class="btn btn-info btn-lg"
																	value="登入" onclick="login()">登入</button>
															</div>
															...
															<div class="modal-dialog">
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		<input type="text" name="againaccount"
																			placeholder="帳號" required=required /> <input
																			type="email" name="againemail" placeholder="信箱"
																			required=required />
																		<div class="modal-footer">
																			<button type="button" class="btn btn-info btn-lg"
																				data-dismiss="modal" onclick="changePassword()">送出</button>
																		</div>
																	</div>
																</div>
										...
										<div class="sign-in-form">
											<div class="in-form Personal">
												...
												<form method="post" action="RegistrationServlet">
													<input type="text" name="newaccount" placeholder="帳號"
														onkeyup="chinese_onkeyup" required=required /> <input
														type="email" name="email" class="textbox" placeholder="信箱"
														required=required /> <input type="password"
														name="newpassword" placeholder="密碼" required=required />
													<input type="password" name="again" placeholder="再次輸入密碼"
														required=required />
													<div class="c
													heck">
														<label class="checkbox"> <input type="checkbox"
															name="checkbox"> <i> </i>我同意使用左邊條款
														</label>
													</div>
