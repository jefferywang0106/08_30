					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse nav-wil"
							...
							<ul class="nav navbar-nav">
								<li><a href="service.xhtml">回首頁</a></li>
								<li><a href="menu.xhtml">我要訂餐</a></li>
								<li class="active"><a href="order.xhtml">發起訂餐</a></li>
								<li><a href="contact.xhtml">聯絡我們</a></li>
								<li><a href="index.xhtml">登出</a></li>
							</ul>
						</div>
						<!-- /.navbar-collapse -->
					</nav>
				...
				<table class="bigForm">
					...
					<h:form>
						...
						<tr>
							...
							<td><h:inputText type="text" name="account"
									value="#{Addstores.restaurant.name}" /></td>
						</tr>
						<tr>
							<td class="label01">簡介:</td>
							<td><h:inputText name="Brief" style="width: 30em;"
									type="text" maxlength="40"
									value="#{Addstores.restaurant.brief}" /></td>
						</tr>
						<tr>
							<td class="label01">電話:</td>
							<td><h:inputText name="Phone" style="width: 30em;"
									type="text" maxlength="40"
									value="#{Addstores.restaurant.phone}" /></td>
						</tr>
						<tr>
							<td class="label01">地址:</td>

							<td><h:inputText name="Addr" style="width: 30em;"
									type="text" maxlength="40" value="#{Addstores.restaurant.addr}" /></td>
					...
					<tr>
						...
						<td>
							...
							<div style="float: left; width: 40em;">
								<table id="mytable" class="table-bordered" border="1">
									<tbody>
										...
										<tr>
											<td><input name="productName" type="text" size="16"
												required=""></td>
											<td><input name="price" type="text" size="16"
												onkeyup="return ValidateNumber(this,value)" required=""></td>
											<td><input type="button" value="刪除"
												onclick="deleteRow(this)"></td>
										</tr>
										<tr>
								...
								<input type="button" value="增加" class="btn btn-default"
									onclick="add_new_data()"> <input type="button"
									value="減少" class="btn btn-default" onclick="remove_data()"><br>
					...
					<tr>
						<td></td>
						<td style="padding-top: 1em;"><h:commandButton value="新增"
								action="#{Addstores.stores}" /></td>
					</tr>
					<tr>
				</table>
			</form>
